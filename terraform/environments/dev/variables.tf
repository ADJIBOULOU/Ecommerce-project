# Variables for EKS E-commerce Platform - Development Environment
...
variable "single_nat_gateway" {
  ...
  type        = bool
  default     = true  # Use single NAT gateway for dev to save costs
}

variable "enable_flow_logs" {
  description = "Enable VPC Flow Logs"
  type        = bool
  default     = false  # Disabled for dev environment to reduce costs
}
