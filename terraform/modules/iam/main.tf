# IAM Module for EKS E-commerce Platform
...
# ALB Ingress Controller Service Account Role
...
# External DNS Service Account Role (optional)
resource "aws_iam_role" "external_dns_role" {
  count = var.enable_external_dns && var.oidc_provider_arn != "" ? 1 : 0
